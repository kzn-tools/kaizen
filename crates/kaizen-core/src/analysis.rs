...
fn create_default_registry() -> RuleRegistry {
    ...
    registry.register(Box::new(EvalInjection::new()));
...
mod tests {
    ...
    fn disable_next_line_suppresses_diagnostic() {
        ...
        let file = make_parsed_file(
            "test.js",
            r#"// kaizen-disable-next-line Q030
var x = 1;"#,
        );
    ...
    fn disable_line_suppresses_diagnostic() {
        let engine = AnalysisEngine::new();
        let file = make_parsed_file("test.js", "var x = 1; // kaizen-disable-line Q030");
...
var x = 1; if (x == 2) {}"#,
    ...
    fn disable_multiple_rules() {
        ...
        let file = make_parsed_file(
            "test.js",
            r#"// kaizen-disable-next-line Q030, Q033
var x = 1; if (x == 2) {}"#,
        );
