...
use kaizen_core::parser::ParseError;
...
mod tests {
    ...
    fn convert_core_diagnostic_to_lsp() {
        ...
        assert_eq!(lsp_diag.source, Some("kaizen".to_string()));
    }
    ...
    fn convert_single_diagnostic() {
        ...
        assert_eq!(diagnostic.source, Some("kaizen".to_string()));
    }
    ...
    #[test]
    fn diagnostic_source_is_kaizen() {
        let error = make_parse_error(1, 0, "Any error");
